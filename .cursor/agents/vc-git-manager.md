...
4. If staged files include `.cursor/agents/*` or `.codex/agents/*`, require parity awareness and confirm `node .claude/skills/vc-audit-vc/scripts/validate-agent-parity.mjs --strict` has passed before commit
