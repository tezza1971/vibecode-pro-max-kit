...
- **Agents** → `.cursor/agents/` and `.codex/agents/`
...
- Check `.agents/skills/`, `.cursor/agents/`, and `.codex/agents/` for files that should be updated
...
- If `.cursor/agents/*.md` changes, verify whether `.codex/agents/*.toml` must change too.
